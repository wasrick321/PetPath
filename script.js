document.addEventListener('DOMContentLoaded', () => {
    ...
    const animals = [
        ...
        { name: 'Mittens', type: 'Street Cat', description: 'A playful cat that loves attention.', image: 'https://th.bing.com/th/id/OIP.kAIUTJrUWLaH5a60vbTgvwAAAA?w=164&h=180&c=7&r=0&o=5&pid=1.7' },
         ...
         { name: 'Shelby', type: 'Dog', description: 'A gentle pet turtle looking for a new home. This calm companion loves basking and exploring, perfect for adding a peaceful touch to your space.', image: 'https://th.bing.com/th/id/OIP.2y3OK9WuFlh9BPffc9oNVAHaEK?w=306&h=180&c=7&r=0&o=5&pid=1.7' },
